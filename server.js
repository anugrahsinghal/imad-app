...
var articles = {
    'article-one' : {
        title: 'Article One | Anugrah Singhal',
        heading: 'Article One',
        date: 'Nov 11,2017',
        content:`
                     <p>
    ...
    'article-three' : {
        title: 'Article Three | Anugrah Singhal',
...
function createTemplate(data) {
    ...
    <body>
        ...
        <form>
            <div class='footer'>
                <textarea name='comments' type='comments' placeholder='hey say' id='comment' style='font-family:sans:serif;font-size:1.2em;'></textarea>
